...
const clasificacionesController = require(
  "../controllers/clasificaciones.controller"
);
...
const handleApiError = (
  ...
  if (
    ...
    return res.status(409).json({
      error:
        "Ya existe una clasificación con ese código asignado.",
    });
  }
  ...
  if (
    ...
    return res.status(404).json({
      error:
        "La clasificación solicitada no existe.",
    });
  }
...
// ======================================================
//
// La consulta del catálogo queda disponible únicamente
// para quienes trabajan con Archivo Físico:
//
// - Gestionar Archivo Físico
// - Consultar Archivo Físico Global
//
  ...
  async (req, res) => {
    try {
      const clasificaciones =
        await clasificacionesController
          .getAll();
  ...
  async (req, res) => {
    try {
      ...
      return handleApiError(
        res,
        error,
        "Error al consultar la clasificación."
      );
    }
  }
);
...
// ======================================================
//
// Solo quien administra el Archivo Físico puede ampliar
// este catálogo desde Ley de Archivo.
//
// ======================================================
