...
const areasController = require(
  "../controllers/areas.controller"
);
...
const PRIVILEGIO_GESTIONAR_AREAS =
  "Gestionar Áreas";
...
router.get(
  ...
  autenticar,
  requierePrivilegio(
    PRIVILEGIO_GESTIONAR_AREAS
  ),
  async (req, res) => {
    try {
      const uso =
        await areasController.getUso(
          req.params.id
        );
